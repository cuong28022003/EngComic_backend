...
public class ToeicReaderMapper {
    ...
    public ToeicTestSummaryDto toSummaryDto(ToeicTestEntity entity) {
        ...
        return ToeicTestSummaryDto.builder()
                ...
                .section(entity.getSection() != null ? entity.getSection() : "reading")
    ...
    public mobile.apis.reader.dtos.ToeicReviewItemDto toReviewItemDto(mobile.databases.entities.reader.ToeicReviewItemEntity entity) {
        ...
        return mobile.apis.reader.dtos.ToeicReviewItemDto.builder()
                ...
                .relatedGrammarTopic(entity.getRelatedGrammarTopic())
    ...
    public mobile.apis.reader.dtos.ToeicAttemptDto toAttemptDto(mobile.databases.entities.reader.ToeicTestAttemptEntity entity) {
        ...
        return mobile.apis.reader.dtos.ToeicAttemptDto.builder()
                ...
                .part1TargetSeconds(entity.getPart1TargetSeconds())
                .part2TargetSeconds(entity.getPart2TargetSeconds())
                .part3TargetSeconds(entity.getPart3TargetSeconds())
                .part4TargetSeconds(entity.getPart4TargetSeconds())
                ...
                .part1ElapsedSeconds(entity.getPart1ElapsedSeconds())
                .part2ElapsedSeconds(entity.getPart2ElapsedSeconds())
                .part3ElapsedSeconds(entity.getPart3ElapsedSeconds())
                .part4ElapsedSeconds(entity.getPart4ElapsedSeconds())
