...
import mobile.apis.vocab.dtos.CreateDeckRequest;
import mobile.apis.vocab.dtos.DeckResponseDto;
import mobile.apis.vocab.dtos.DeckStatisticsResponse;
...
public class DeckController {
    ...
    private DeckStatisticsResponse getDeckStatistics(String deckId) {
        ...
        List<VocabRules.CardProgress> cardProgressList = cards.stream()
                .map(c -> new VocabRules.CardProgress(
                        c.getId(),
                        c.getRepetition(),
                        c.getInterval(),
                        c.getEaseFactor(),
        ...
        VocabRules.DeckStatistics summary = VocabRules.calculateStatistics(cardProgressList, new Date());
